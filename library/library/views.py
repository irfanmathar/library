...
def add_book(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            return redirect('/inventory/listbook/')  # Redirect to book list after saving
        else:
...
def add_member(request):
    if request.method == 'POST':
        ...
        if forms.is_valid():
            ...
            forms.save()
            return redirect('/inventory/transaction/')  # Redirect to the member list after saving
        else:
            # If the form is invalid, re-render the form with error messages
...
def add_transaction(request):
    ...
    if request.method == 'POST':
        ...
        if transaction_form.is_valid():
            ...
            return redirect('/inventory/transaction_list/')  # Redirect to book list after saving
        else:
            # If the form is invalid, re-render the form with error messages
...
def add_staff(request):
    if request.method == 'POST':
        ...
        if staff_form.is_valid():
            # Save the new book to the database
            staff_form.save()
            return redirect('/inventory/dashboard/')  # Redirect to book list after saving
        else:
            # If the form is invalid, re-render the form with error messages
